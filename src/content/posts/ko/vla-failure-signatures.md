...
이 글은 **[1]에서 [3]까지**를 다룹니다. 무엇을 감시할지가 정해져야 [4]에서 무엇을 막을지도 정해지기 때문입니다. [4]는 마지막에 짧게만 다룹니다.
...
전통적인 안전 리미터는 한계선을 넘는지를 봅니다. 그런데 AI의 실패는 **한계 안에서** 일어납니다. ACT에서 4,758번 울린 경보가 성공과 실패를 거의 갈라내지 못했습니다. 경보가 틀린 게 아니라, 그 경보가 재던 것이 애초에 실패와 상관이 적었습니다.
